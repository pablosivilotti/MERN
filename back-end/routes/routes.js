...
const loginCtrl = require('../controlador/login'); 
...
api.post('/logins/', [check('email', 'Invalid Email adress').isEmail(),
                        check('password','Password must be min 5 characters').isLength({ min: 5 })],loginCtrl.postLogin)
